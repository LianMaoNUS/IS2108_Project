...
urlpatterns = [
    ...
    path('checkout/', views.checkout_page.as_view(), name='checkout'),
    path('order-confirmation/<str:order_id>/', views.order_confirmation_page.as_view(), name='order_confirmation'),
    path('profile/', views.profile_page.as_view(), name='profile'),
